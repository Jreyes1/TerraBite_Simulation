...
import numpy as np
import math
from readSensors import gpsRobot,compassRobot,getDroneImage,ROI
...
def findlines(image):
    ...
    edges = cv2.Canny(image,50, 100, 3)
...
def main():
    ...
    # camera parameters (using same camera for drone and navigation)
    droneHeight = 10                    # Set Drone Height
    cameraFOV = math.radians(84.9)         # degrees
...
#    return
    ...
    pixDistRatio = resolution[0]/(2*droneHeight*math.tan(cameraFOV/2))
